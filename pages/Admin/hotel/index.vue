...
<template>
  <div class="">
    ...
    <atoms-container v-else>
      <br />
      <section class="grid justify-center grid-cols-1 gap-10 md:grid-cols-5 md:items-center">
      ...
      <n-scrollbar x-scrollable>
        <div class="flex mb-10 space-x-10">
          <n-card
            v-for="(_shortcut, _ishortcut) in [
              {
                title: 'Room',
                icon: 'bed',
                href: '/admin/hotel/room',
              },
              {
                title: 'Availability',
                icon: 'check',
                href: '/admin/hotel/availibility',
              },
              {
                title: 'Order',
                icon: 'history',
                href: '/admin/hotel/order',
              },
              // {
              //   title: 'Payment',
              //   icon: 'timetable',
            ...
            "
          >
            <div class="flex flex-col items-center justify-center w-full h-full gap-5 pt-1">
      ...
      <n-divider title-placement="left" class="!text-primary !mt-0">
        <div class="flex items-center gap-2">
          ...
          <atoms-text span class="!text-inherit">Current Rooms</atoms-text>
        </div>
      </n-divider>
      ...
      <section v-else-if="$local.data?.length > 0" class="space-y-5">
        ...
        >
          <section class="grid grid-cols-5">
            ...
            <div
              ...
              @click.stop="router.push({ path: '/admin/hotel/room/' + _item.id })"
            >
                    ...
                    :options="[
                      {
                        ...
                        props: {
                          onClick: () =>
                            router.push({ path: '/admin/hotel/room/submit/' + _product.id }),
                        },
                      },
                      {
                        key: 1,
        ...
        <n-button @click="router.push({ path: `/admin/${$userStore.getClientTypeApp}/room` })"
          >Show More</n-button
        >
      </section>
      <atoms-empty
